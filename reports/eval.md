...
| [참고] 네이버 자체 승률 (n=301,713) |     0.4559 |  0.1516 | 0.8627 | 0.7668 | 301713 |
| [참고] 우리 모델 (동일 구간)         |     0.467  |  0.1554 | 0.8536 | 0.761  | 301713 |

> 테스트 홀드아웃은 경기 수가 적어 분할 운에 따라 순위가 뒤집힌다. 같은 폴드에서 만든 OOF 예측으로 비교하면 학습 경기 전체가 표본이 되어 안정적이다.

## 모델 비교 — 테스트 홀드아웃 (228경기)
...
| [참고] 네이버 자체 승률 (n=73,890)      |     0.4279 |  0.1426 | 0.879  | 0.7753 | 73890 |
| [참고] 우리 모델 (동일 구간)             |     0.4327 |  0.1452 | 0.8724 | 0.7689 | 73890 |
