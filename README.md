# KBO 실시간 승률 예측
![KBO League](https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTKrCMuAq0MnQeTeQ3t5wAug9rwgu7vZxKW26C-kp972NmryYlr85DRqZU3&s=10)

야구 경기가 진행되는 동안, 지금 어느 팀이 이길 확률이 몇 퍼센트인지 계산한다.
숫자만 내놓지 않고 왜 그 숫자가 나왔는지, 경기 흐름이 어디서 바뀌었는지도 같이 보여준다.

**[→ 프로젝트 소개 페이지](https://geonwoong-lee.github.io/KBO_Win_Probability/)**
전체 과정과 결과를 읽기 편하게 정리한 페이지입니다.
...
Cross Validation(908경기)에서도 같은 방향이 나왔다.
